...
% FIXME Umlaute
\code{Uebung_03/gemeinheiten.txt}{Gemeinheiten fuer Listing \ref{code:auto-einfach}}{code:gemeinheiten}
...
% FIXME Umlaute
\code[bash]{Uebung_03/psauxgrep-beginning.sh}{Einschaenkung des Suchbereichs}{code:psauxgrep-beginning}
