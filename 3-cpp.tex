...
\lstinputlisting[caption=arrays.cpp, label=code:arrays.cpp]{Uebung_07/arrays/arrays.cpp}
...
\lstinputlisting[caption=bericht.cpp, label=code:bericht.cpp]{Uebung_07/bericht/bericht.cpp}
...
Sie finden die Dateien für diese Übung im Ordner \texttt{Uebung\_08}.
