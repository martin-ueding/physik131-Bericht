...
Dies ist das einfache \gqq{Hello, World!}-Programm, das Kerningham und Ritchie zum Einstieg empfehlen um seine Entwicklungsumgebung entsprechend einzurichten.
...
\lstinputlisting[caption=Ausgabe von ethiopian-ng, label=code:ethiopian-ng.short.out, float=htb]{Uebung_06/ethiopian-ng/ethiopian.out}
...
\code[c++]{Uebung_08/Student/main.cpp}{String main.cpp}{}
\code[c++]{Uebung_08/Student/student.cpp}{String student.cpp}{}
\code[c++]{Uebung_08/Student/student.h}{String student.h}{}

\section{Berichtsaufgabe}
\code[c++]{Uebung_08/Consolidator/main.cpp}{Consolidator}{}
