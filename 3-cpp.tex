...
% caption=Consolidator main.cpp, label=, language=c++
\begin{listing}
\label{code:consolidator-main.cpp}
\caption{Consolidator main.cpp}
\inputminted[label=Consolidator]{c++}{Uebung_08/Consolidator/main.cpp}
\end{listing}

Code \ref{code:consolidator-main.cpp}, Seite \pageref{code:consolidator-main.cpp}
