...
Ein Anhang mit Code Listings war vorhanden, allerdings hätte ich damit zu viele Seiten gehabt.
...
Die Linuxbefehle (§\ref{commands}) habe ich als \texttt{itemize} gehalten, was ich übersichtlicher finde. Eine Tabelle ist auf Seite \pageref{table:fit} zu finden.
